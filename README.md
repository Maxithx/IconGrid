...
Dette projekt benytter LibreHardwareMonitorLib til at læse sensorværdier.
...
Build & run
Installer .NET SDK (targets net10.0-windows).

Kør dotnet build IconGrid.sln -c Debug fra roden.

Konfiguration og logs gemmes under %APPDATA%\IconGrid.