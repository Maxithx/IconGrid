...
namespace IconGrid.ViewModels
{
    public partial class MainViewModel
    {
        ...
        public string UsbCopyNavTitle => _localizationState.Get(Language, "UsbCopyNavTitle");
        public string UsbCopyTitle => _localizationState.Get(Language, "UsbCopyTitle");
        public string UsbCopyIntro => _localizationState.Get(Language, "UsbCopyIntro");
        public string UsbCopyDevicesTitle => _localizationState.Get(Language, "UsbCopyDevicesTitle");
        public string UsbCopyDevicesDescription => _localizationState.Get(Language, "UsbCopyDevicesDescription");
        public string UsbCopyNoDevice => _localizationState.Get(Language, "UsbCopyNoDevice");
        public string UsbCopyRefreshButton => _localizationState.Get(Language, "UsbCopyRefreshButton");
        public string UsbCopyPortTypeLabel => _localizationState.Get(Language, "UsbCopyPortTypeLabel");
        public string UsbCopyCapacityLabel => _localizationState.Get(Language, "UsbCopyCapacityLabel");
        public string UsbCopyFreeSpaceLabel => _localizationState.Get(Language, "UsbCopyFreeSpaceLabel");
        public string UsbCopyCopyTitle => _localizationState.Get(Language, "UsbCopyCopyTitle");
        public string UsbCopyCopyDescription => _localizationState.Get(Language, "UsbCopyCopyDescription");
        public string UsbCopyChooseFilesButton => _localizationState.Get(Language, "UsbCopyChooseFilesButton");
        public string UsbCopySelectedFilesLabel => _localizationState.Get(Language, "UsbCopySelectedFilesLabel");
        public string UsbCopyBufferSizeLabel => _localizationState.Get(Language, "UsbCopyBufferSizeLabel");
        public string UsbCopyStartButton => _localizationState.Get(Language, "UsbCopyStartButton");
        public string UsbCopyCancelButton => _localizationState.Get(Language, "UsbCopyCancelButton");
        public string UsbCopyNoFilesSelected => _localizationState.Get(Language, "UsbCopyNoFilesSelected");
        public string UsbCopyTargetDeviceLabel => _localizationState.Get(Language, "UsbCopyTargetDeviceLabel");
        public string UsbCopyPerformanceTitle => _localizationState.Get(Language, "UsbCopyPerformanceTitle");
        public string UsbCopyLiveSpeedLabel => _localizationState.Get(Language, "UsbCopyLiveSpeedLabel");
        public string UsbCopyAverageLabel => _localizationState.Get(Language, "UsbCopyAverageLabel");
        public string UsbCopyPeakLabel => _localizationState.Get(Language, "UsbCopyPeakLabel");
        public string UsbCopyEtaLabel => _localizationState.Get(Language, "UsbCopyEtaLabel");
        public string UsbCopyPipelineStatusLabel => _localizationState.Get(Language, "UsbCopyPipelineStatusLabel");
        public string UsbCopyLogTitle => _localizationState.Get(Language, "UsbCopyLogTitle");
        public string UsbCopyViewLogButton => _localizationState.Get(Language, "UsbCopyViewLogButton");
        public string UsbCopyExportLogButton => _localizationState.Get(Language, "UsbCopyExportLogButton");
        public string UsbCopyClearLogButton => _localizationState.Get(Language, "UsbCopyClearLogButton");
        public string UsbCopyLogEmpty => _localizationState.Get(Language, "UsbCopyLogEmpty");
        public string UsbCopyBenchmarkTitle => _localizationState.Get(Language, "UsbCopyBenchmarkTitle");
        public string UsbCopyBenchmarkDescription => _localizationState.Get(Language, "UsbCopyBenchmarkDescription");
        public string UsbCopyRunBenchmarkButton => _localizationState.Get(Language, "UsbCopyRunBenchmarkButton");
        public string UsbCopyPortSpeedTestButton => _localizationState.Get(Language, "UsbCopyPortSpeedTestButton");
        public string UsbCopyReadTestButton => _localizationState.Get(Language, "UsbCopyReadTestButton");
        public string UsbCopyWriteTestButton => _localizationState.Get(Language, "UsbCopyWriteTestButton");
        public string UsbCopyBufferStressTestButton => _localizationState.Get(Language, "UsbCopyBufferStressTestButton");
        public string UsbCopyStabilityTestButton => _localizationState.Get(Language, "UsbCopyStabilityTestButton");
        public string UsbCopyWindowsBaselineButton => _localizationState.Get(Language, "UsbCopyWindowsBaselineButton");
        public string UsbCopyWindowsBaselineDescription => _localizationState.Get(Language, "UsbCopyWindowsBaselineDescription");
        public string UsbCopyExportCsvButton => _localizationState.Get(Language, "UsbCopyExportCsvButton");
        public string UsbCopyBenchmarkNoResults => _localizationState.Get(Language, "UsbCopyBenchmarkNoResults");
        ...
        private void NotifyLocalizationPropertiesChanged()
        {
            ...
            OnPropertyChanged(nameof(UsbCopyNavTitle));
            OnPropertyChanged(nameof(UsbCopyTitle));
            OnPropertyChanged(nameof(UsbCopyIntro));
            OnPropertyChanged(nameof(UsbCopyDevicesTitle));
            OnPropertyChanged(nameof(UsbCopyDevicesDescription));
            OnPropertyChanged(nameof(UsbCopyNoDevice));
            OnPropertyChanged(nameof(UsbCopyRefreshButton));
            OnPropertyChanged(nameof(UsbCopyPortTypeLabel));
            OnPropertyChanged(nameof(UsbCopyCapacityLabel));
            OnPropertyChanged(nameof(UsbCopyFreeSpaceLabel));
            OnPropertyChanged(nameof(UsbCopyCopyTitle));
            OnPropertyChanged(nameof(UsbCopyCopyDescription));
            OnPropertyChanged(nameof(UsbCopyChooseFilesButton));
            OnPropertyChanged(nameof(UsbCopySelectedFilesLabel));
            OnPropertyChanged(nameof(UsbCopyBufferSizeLabel));
            OnPropertyChanged(nameof(UsbCopyStartButton));
            OnPropertyChanged(nameof(UsbCopyCancelButton));
            OnPropertyChanged(nameof(UsbCopyNoFilesSelected));
            OnPropertyChanged(nameof(UsbCopyTargetDeviceLabel));
            OnPropertyChanged(nameof(UsbCopyPerformanceTitle));
            OnPropertyChanged(nameof(UsbCopyLiveSpeedLabel));
            OnPropertyChanged(nameof(UsbCopyAverageLabel));
            OnPropertyChanged(nameof(UsbCopyPeakLabel));
            OnPropertyChanged(nameof(UsbCopyEtaLabel));
            OnPropertyChanged(nameof(UsbCopyPipelineStatusLabel));
            OnPropertyChanged(nameof(UsbCopyLogTitle));
            OnPropertyChanged(nameof(UsbCopyViewLogButton));
            OnPropertyChanged(nameof(UsbCopyExportLogButton));
            OnPropertyChanged(nameof(UsbCopyClearLogButton));
            OnPropertyChanged(nameof(UsbCopyLogEmpty));
            OnPropertyChanged(nameof(UsbCopyBenchmarkTitle));
            OnPropertyChanged(nameof(UsbCopyBenchmarkDescription));
            OnPropertyChanged(nameof(UsbCopyRunBenchmarkButton));
            OnPropertyChanged(nameof(UsbCopyPortSpeedTestButton));
            OnPropertyChanged(nameof(UsbCopyReadTestButton));
            OnPropertyChanged(nameof(UsbCopyWriteTestButton));
            OnPropertyChanged(nameof(UsbCopyBufferStressTestButton));
            OnPropertyChanged(nameof(UsbCopyStabilityTestButton));
            OnPropertyChanged(nameof(UsbCopyWindowsBaselineButton));
            OnPropertyChanged(nameof(UsbCopyWindowsBaselineDescription));
            OnPropertyChanged(nameof(UsbCopyExportCsvButton));
            OnPropertyChanged(nameof(UsbCopyBenchmarkNoResults));
        }
